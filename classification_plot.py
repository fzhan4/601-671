...
def train(mymodel, num_epochs, train_dataloader, validation_dataloader, device, lr, plot_name=None):
    ...
    for epoch in range(num_epochs):
        ...
        train_accuracy_computed = train_accuracy.compute()
        print(f" - Average training metrics: accuracy={train_accuracy_computed}")
        ...
        train_acc_list.append(train_accuracy_computed['accuracy'])
    ...
    plt.legend()
    fig.savefig(f'acc_plot_{plot_name}.png')
...
if __name__ == "__main__":
    ...
    ### My code here ###
    train(pretrained_model, args.num_epochs, train_dataloader, validation_dataloader, args.device, args.lr, args.experiment)
